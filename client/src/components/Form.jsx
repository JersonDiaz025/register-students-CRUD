      ...
      <div className='container-main-form'>
        <div className='container-form'>
          ...
          <form className='form' onSubmit={handleSubmit}>
            ...
            <input id="input" placeholder="Calificación del estudiante" name="calification" type="number" onChange={handleChange} value={values.calification} required/>
            <input id="input" placeholder="Correo electrónico" name="email" type="email" onChange={handleChange} value={values.email} required/>
            <input id="input" placeholder="809-444-5555" type="tel" name="phone_number" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" onChange={handleChange} value={values.phone_number} required/>
