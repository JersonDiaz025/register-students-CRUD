...
const ModalEdit = (props) => {
    const { text_title, text_button, text_button_close,
        handleCloseModal, handleSendUpdate, dataEdit} = props;
            ...
            <div className='container-form-modal'>
                ...
                <form className='form-modal'>
                    <div className='container-label'>
                        ...
                        <input id="input-modal" name="name" type="text"value={dataEdit.name}/>
                    </div>
                    <div  className='container-label'>
